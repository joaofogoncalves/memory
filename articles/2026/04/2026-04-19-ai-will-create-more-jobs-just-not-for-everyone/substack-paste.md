...
2. **Subtitle:** Jevons paradox is real. So is the door policy.
3. **Canonical URL** (Post settings → SEO → Canonical URL): `https://yoursite.com/articles/2026/04/2026-04-19-ai-will-create-more-jobs-just-not-for-everyone/` — this keeps SEO pointed at your site, not Substack. (Replace `yoursite.com` with your actual site domain.)
4. **Hero image:** once you've generated the hero, upload `media/hero-*.png` at the top of the post (Substack strips local paths on paste; you have to upload through their UI).
5. **Inline images:** re-upload these as you reach them in the body:
   - `media/wage-premium-jump.webp` — goes in "The part nobody prices in"
   - `media/two-doors.webp` — goes in "Who gets the new jobs"
...
7. At the end of the post, add this canonical-pointer line so readers who found you on Substack know where the piece actually lives:
   ...
   > Originally published at [yoursite.com/articles/2026/04/2026-04-19-ai-will-create-more-jobs-just-not-for-everyone](https://yoursite.com/articles/2026/04/2026-04-19-ai-will-create-more-jobs-just-not-for-everyone/).
...
He was right. A year later, the data is lopsided in his favor. US engineering job listings are [up 30% in 2026](https://www.metaintro.com/blog/software-engineer-job-listings-spike-2026-ai-demand). AI coding tool experience as a listed requirement is up 340%. [PwC's 2025 Global AI Jobs Barometer](https://www.pwc.com/gx/en/services/ai/ai-jobs-barometer.html) clocked productivity growth at roughly 4x in AI-exposed industries. The total labor pie is growing, and it's growing fastest exactly where people predicted it would shrink.
...
Junior developer postings are [down about 40%](https://stackoverflow.blog/2025/12/26/ai-vs-gen-z/) compared to pre-2022 levels. Engineering postings overall are up 30%, but the composition has shifted. Experienced roles are expanding. Entry-level roles are vanishing.
...
[IMAGE: AI wage premium doubled in a single year — upload media/wage-premium-jump.webp here]
...
The [Anthropic Economic Index from March 2026](https://www.anthropic.com/research/economic-index-march-2026-report) adds a quieter datapoint. Roughly 49% of jobs have had at least a quarter of their tasks performed using Claude. In computer and math roles, the theoretical coverage is 94%. The actual usage is around 33%. The gap between what AI can do and what people are doing with it is enormous, and it's where the distribution is separating.
...
- Add a `substack_url:` field to the article frontmatter (it's already present, just fill in the value).
