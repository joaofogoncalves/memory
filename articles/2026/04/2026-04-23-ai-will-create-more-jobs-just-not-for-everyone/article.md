...
::: wide
![PC era: 5–15 years for IT productivity to show up in statistics. AI era: 10 months for Anthropic's task coverage to move 36% → 49%.](media/adaptation-window.webp)
:::
...
::: wide
![4× growth in code clones and 54% more bugs per developer on high-AI teams (GitClear 2025)](media/quality-debt-gitclear.webp)
:::
