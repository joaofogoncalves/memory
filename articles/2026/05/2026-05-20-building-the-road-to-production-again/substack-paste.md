# Substack paste-in — Building the Road to Production, Again

## Posting checklist (do these in Substack's editor)

1. **Title:** Building the Road to Production, Again
2. **Subtitle:** The SDLC patterns that scaled three people to 400 deployments transfer cleanly to agentic engineering. The detection assumption underneath them doesn't.
3. **Canonical URL** (Post settings → SEO → Canonical URL): `https://joaofogoncalves.com/articles/2026/05/2026-05-20-building-the-road-to-production-again/` — this keeps SEO pointed at your site, not Substack.
...
5. **Inline images:** re-upload this as you reach it in the body:
   - `media/road-then-now.webp`
6. **YouTube embed:** the "motto" section contains an embedded YouTube video (the 2022 Valispace interview at `https://www.youtube.com/watch?v=kDQQJfrIrdY`). Substack supports YouTube embeds — paste the URL on its own line where indicated in the body and Substack will inline the player.
7. **Tags:** ai, software-engineering, devops, agents, engineering-leadership, claude-code
8. At the end of the post, add this canonical-pointer line so readers who found you on Substack know where the piece actually lives:

   > Originally published at [joaofogoncalves.com/articles/2026/05/2026-05-20-building-the-road-to-production-again](https://joaofogoncalves.com/articles/2026/05/2026-05-20-building-the-road-to-production-again/).
...
In 2022 someone interviewed me about being Head of DevOps at [Valispace](https://www.valispace.com/). I said the team motto out loud, probably for the first time on camera: "building the road to production."
...
[YOUTUBE EMBED: paste this URL on its own line — https://www.youtube.com/watch?v=kDQQJfrIrdY]
...
[IMAGE: Four SDLC patterns from Valispace map cleanly to agentic engineering. The fifth — cheap, detectable failure — is the one that breaks. — upload media/road-then-now.webp here]
...
This decision is downstream of one most teams haven't answered: ["AI-first" or AI-assisted?](https://joaofogoncalves.com/articles/2026/04/2026-04-18-your-ai-first-engineering-org-probably-isnt/) You can't pick the right inference layer until you've decided what shape of work the agents are actually doing.
...
The metrics most teams track for the agent loop are lead time and deploy frequency, the DORA staples. They measure the easy half. [The actual constraint sits upstream of all of them](https://joaofogoncalves.com/articles/2026/05/2026-05-14-lead-time-is-the-wrong-half/) — and for the agent-PR loop specifically, the actual constraint is whether the failures the loop produces are the ones the loop can see.
