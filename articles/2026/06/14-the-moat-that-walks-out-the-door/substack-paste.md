# Substack paste-in — The Moat That Walks Out the Door

## Posting checklist (do these in Substack's editor)

1. **Title:** The Moat That Walks Out the Door
2. **Subtitle:** Part three. If the moat is the judgment in your team's heads, then the moat can quit. What it takes to keep that judgment from leaving with the people who hold it.
3. **Canonical URL** (Post settings → SEO → Canonical URL): `https://joaofogoncalves.com/articles/2026/06/14-the-moat-that-walks-out-the-door/` — keeps SEO pointed at your site, not Substack.
4. **Hero image:** upload `media/hero.jpg` at the top of the post (Substack strips local paths on paste; upload through their UI).
5. **Inline images:** re-upload as you reach it in the body:
   - `media/runbook-vs-judgment.webp`
6. **Tags:** ai, software-engineering, engineering-leadership
7. At the end of the post, the canonical-pointer line is already included below.

Note: internal links in the body have been rewritten to absolute `joaofogoncalves.com` URLs so they resolve on Substack and pull readers back to the canonical site.
...
[IMAGE: What documentation holds versus what walks out the door: the skill files and runbooks transfer cleanly; the judgment underneath them does not. — upload media/runbook-vs-judgment.webp here]

Your [ledger of incidents](https://joaofogoncalves.com/articles/2026/06/11-rent-the-loop-build-the-moat/) records the answer to the last failure. It cannot record the instinct for the next one, the failure nobody has seen yet, the one that matches no entry in the book.
...
> Originally published at [joaofogoncalves.com/articles/2026/06/14-the-moat-that-walks-out-the-door](https://joaofogoncalves.com/articles/2026/06/14-the-moat-that-walks-out-the-door/).
...
- Update the `substack_url:` field in `article.md` frontmatter.
