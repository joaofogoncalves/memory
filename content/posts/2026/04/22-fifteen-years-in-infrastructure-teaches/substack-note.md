# Substack Note — fifteen-years-in-infrastructure-teaches
...
The problem isn't ours. Anyone running distributed infrastructure has felt the same friction. Keeping the tool private would have meant hoarding a solution to a shared problem.
