# Substack Note — a-bad-deploy-is-legible

Paste into Substack Notes (substack.com/notes). No hashtags. Link welcome.

---

A bad deploy is legible. The alert fires, the rollback runs, blast radius is the customer base, recovery is measured in minutes. That's why two-week cycles worked. Failure was cheap because failure was loud.
