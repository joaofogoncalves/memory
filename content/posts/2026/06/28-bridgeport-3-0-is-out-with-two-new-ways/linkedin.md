# LinkedIn post — bridgeport-3-0-is-out-with-two-new-ways

Paste into LinkedIn's composer. Zero emojis, hashtags at the end. The article link goes in the FIRST COMMENT (not the body) to avoid the reach penalty on external links.
...
It's all open source. Full write-up in the first comment.

#MCP #SelfHosted #OpenSource #DevTools
...
How the two surfaces are the same API contract projected two ways: https://joaofogoncalves.com/articles/2026/06/28-two-features-one-contract/
