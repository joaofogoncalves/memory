...
source_urls:
  - https://lisbonai.org/
angle: Builders not keynotes — Lisbon AI designed around shipping density / laptop hallway culture, stage secondary to between-session conversations
template: short-form
---
...
![image-1.svg](media/image-1.svg)

![image-2.svg](media/image-2.svg)

![image-3.svg](media/image-3.svg)
