# Substack Note — software-engineering-has-always-filtered-people

Paste into Substack Notes (substack.com/notes). No hashtags. Links welcome.

---

Software engineering has always filtered people. There's an assumption going around that the filter is about to disappear, because the models write the code now. I don't think it's disappearing. I think it's moving.
